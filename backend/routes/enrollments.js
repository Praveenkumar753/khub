...
router.get('/my-courses', async (req, res) => {
    try {
        ...
        const coursesWithProgress = enrollments.map(enrollment => {
            // Recalculate total topics from the course (in case content was added/removed)
            ...
            // Recalculate completion percentage with updated totalTopics
            if (userProgress && enrollment.totalTopics > 0) {
                userProgress.completionPercentage = 
                    (userProgress.completedTopics.length / enrollment.totalTopics) * 100;
            }
        ...
        // Save updated enrollments with recalculated values
